...
> 自动生成于 2026-03-25T01:07:11.101Z
...
| # | 测试名称 | 状态 | 详情 | 耗时 |
|---|----------|------|------|------|
| 1 | 首页加载 | ✅ PASS | 标题: EAT Agent Workbench, 导航标签: 7 个 | 3.0s |
| 2 | 注册 evat 项目 | ✅ PASS | 项目名: EV
        
          evat
          /home/code/evat | 5.6s |
| 3 | 选择项目仪表盘 | ✅ PASS | 默认分支: master | 6.6s |
| 4 | 任务创建视图 | ✅ PASS | 表单已渲染 | 7.3s |
| 5 | 创建 Todo List 任务 | ✅ PASS | 反馈: 已创建任务 实现 Todo List 功能。准备好后即可开始澄清。 | 9.5s |
| 6 | 工作区布局验证 | ✅ PASS | 紧凑头栏 ✓, 标签栏 ✓, 聊天面板 ✓ | 12.2s |
| 7 | 标签页切换 | ✅ PASS | overview: ✓, document: ✓, plan: ✓, team: ✓ | 14.3s |
| 8 | 溢出菜单 | ✅ PASS | 菜单项: 删除, 刷新; 点击外部关闭: ✓ | 15.1s |
| 9 | 预览弹层 | ✅ PASS | 表单元素: 预览目标选择器, 启动命令输入, 端口输入 | 16.7s |
| 10 | 重复注册项目 | ✅ PASS | 反馈: 该仓库已注册在 /home/code/evat。 | 19.3s |
| 11 | 无效路径注册 | ✅ PASS | 错误提示: 该路径不存在，请检查后重试。 | 21.9s |
| 12 | 空表单提交 | ✅ PASS | HTML5 表单验证阻止提交 | 24.2s |
| 13 | 工作区空状态 | ✅ PASS | 已有任务选中 | 25.2s |
| 14 | 多视图导航 | ✅ PASS | 控制台: ✓, 任务创建: ✓, 工作区: ✓, 指标: ✓ | 27.4s |
| 15 | 侧边栏折叠 | ✅ PASS | 折叠状态切换: ✓ | 28.3s |
| 16 | 顶部导航折叠 | ✅ PASS | 导航折叠切换: ✓ | 29.2s |
| 17 | API 创建任务 | ⚠️ WARN | HTTP 400: {"code":"LEAD_AGENT_INVALID","message":"Lead agent must be a registered orchestrator.","details":{"leadAgentTy | 29.2s |
| 18 | 紧凑头栏验证 | ⏭️ SKIP | 无任务选中 | 29.2s |
| 19 | 聊天面板 | ⏭️ SKIP | 聊天面板不可见 | 29.2s |
| 20 | 响应式布局 | ✅ PASS | desktop 1920x1080, laptop 1366x768, tablet 1024x768 | 31.4s |
| 21 | 语言切换 | ✅ PASS | 切换前: English → 切换后: 中文 | 32.7s |
| 22 | 计划审阅视图 | ✅ PASS | 视图已加载 | 33.7s |
| 23 | 运行看板视图 | ✅ PASS | 视图已加载 | 34.7s |
| 24 | 指标视图 | ✅ PASS | 视图已加载 | 35.7s |
| 25 | 完整页面截图 | ✅ PASS | 仪表盘 + 任务创建 + 工作区 | 38.3s |
